...
export default function Edit( { attributes, setAttributes } ) {
	...
	// Define a debounced version of the updateColumn function
const debouncedUpdateColumn = debounce((columnIndex, field, value) => {
    updateColumn(columnIndex, field, value);
	...
	const onSortEnd = ( { oldIndex, newIndex } ) => {
        // setElements( arrayMoveImmutable( columns, oldIndex, newIndex ) );
		setAttributes( {columns :arrayMoveImmutable( columns, oldIndex, newIndex ) });
    };

	const SortableItem = SortableElement( ( { column, colIndex: index } ) => 
<div
										...
										<input
											...
											onChange={ ( content ) =>
												updateColumn(
													...
													'col_id',
													content.target.value,
													debouncedUpdateColumn(index, 'col_id', content.target.value)
												)
											}
										/>
									</div>
		...
		<>
			...
			<section { ...useBlockProps() }>
				...
				<div className="column-wrapper">
					<SortableList columns={ columns } onSortEnd={ onSortEnd } />
					{/* { columns.map( ( column, index ) => {
						return (
							<div
								className={ `column ${ column.col_class }` }
